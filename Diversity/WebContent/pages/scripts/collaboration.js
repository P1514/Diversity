...
function submit() {
	...
	var url = "https://diversity.euprojects.net/collaborationTool/suggestions";
	$.post(url, result, function () { console.log('success'); });
	...
	$.ajax({
		...
		success: function() { console.log(JSON.stringify(result)); },
		dataType: "text",
