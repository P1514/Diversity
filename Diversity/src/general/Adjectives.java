...
public final class Adjectives {
	...
	public Adjectives() {
		...
		adjectives.put("quite flexible", 82.0);
		...
		adjectives.put("supportive", 72.0);
		...
		adjectives.put("stone rigid", 	12.0);
	}
